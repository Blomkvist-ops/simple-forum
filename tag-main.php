<html>
    ...
    <body>
        ...
        <form method="POST" action="tag-main.php">
        ...
        <!-- <h2>Insert Values into tagTable</h2> -->
        <h2>Insert a new Tag</h2>
        <form method="POST" action="tag-main.php"> <!--refresh page when submitted-->
            <input type="hidden" id="insertQueryRequest" name="insertQueryRequest">
            Tag ID: <input type="text" name="insId"> <br /><br />
        ...
        <form method="POST" action="tag-main.php"> <!--refresh page when submitted-->
            ...
            Tag ID: <input type="text" name="matchTagID"> <br /><br />
        ...
        <h2>Count the Tuples in tagTable</h2>
        <form method="GET" action="tag-main.php"> <!--refresh page when submitted-->
            <input type="hidden" id="countTupleRequest" name="countTupleRequest">
            <input type="submit" value="Submit Query" name="countTuples"></p>
        </form>

        <h2>Display the tuples in tagTable</h2>
        <form method="GET" action="tag-main.php"> <!--refresh page when submitted-->
        ...
        function printResult($result) { //prints results from a select statement
            echo "<br>Retrieved data from table tagTable:<br>";
            echo "<table>";
            echo "<tr><th>TagID</th><th>Description</th></tr>";
        ...
        function handleUpdateRequest() {
            ...
            executePlainSQL("UPDATE tagTable SET content='" . $new_content . "' WHERE postID='" . $postId_To_Update . "'");
            OCICommit($db_conn);
        }
        ...
        function handleResetRequest() {
            global $db_conn;
            // Drop old table
            executePlainSQL("DROP TABLE tagTable cascade constraints");

            // Create new table
            echo "<br> creating new table <br>";
            executePlainSQL("CREATE TABLE tagTable (tagID int PRIMARY KEY, descrip char(30))");
            OCICommit($db_conn);
        }
        ...
        function handleInsertRequest() {
            ...
            executeBoundSQL("insert into tagTable values (:bind1, :bind2)", $alltuples);
            OCICommit($db_conn);
        }
        ...
        function handleMatchRequest() {
            ...
            $matchTagID = $_POST['matchTagID'];
            
            $result = executePlainSQL("SELECT tagID, descrip FROM tagTable WHERE tagID = '$matchTagID'");
        ...
        function handleCountRequest() {
            ...
            $result = executePlainSQL("SELECT Count(*) FROM tagTable");

            if (($row = oci_fetch_row($result)) != false) {
                echo "<br> The number of tuples in tagTable: " . $row[0] . "<br>";
            }
        }
        ...
        function handleDisplayTuplesRequest() {
            ...
            $result = executePlainSQL("SELECT tagID,descrip FROM tagTable");
